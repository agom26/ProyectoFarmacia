            ...
            <section class="row 6">
                ...
                <article class="col-xs-12 col-sm-12 col-md-6 col-lg-6"> <!-- si -->
                    <div class="form-floating mb-3">
                        <input type="text" name="codigo" class="form-control form-floating mb-3" placeholder="Codigo" value="{{old('codigo')}}">
                    ...
                    <div class="form-floating mb-3">
                        <input type="text" name="descripcion" class="form-control form-floating mb-3" placeholder="descripcion" value="{{old('descripcion')}}">
                    ...
                    <div class="form-floating mb-3">
                        <input type="decimal" name="precio"  class="form-control form-floating mb-3" placeholder="precio"  value="{{old('precio')}}">
                    ...
                    <div class="form-floating mb-3">
                        <input type="text" name="existencia"  class="form-control form-floating mb-3" placeholder="Existencia" value="{{old('existencia')}}">
